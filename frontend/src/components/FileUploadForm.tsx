...
export default function FileUploadForm({ setIsProcessing, setLogs, setPreviousGenerations }: { setIsProcessing: (f:boolean)=>void, setLogs: (f:string[])=>void, setPreviousGenerations: (f:any)=>void }) {
  ...
  return (
    <form action={formAction} className="space-y-4">
      <div className="grid gap-2">
        ...
        <Input accept=".zip" className="flex-1" id="gtfs-file" onChange={handleFileChange} type="file" />
      </div>
      <div className="grid gap-2">
