...
export default async function Footer({ direction_id, facilities, line_id, stop_id, user_url }: { direction_id: string, facilities: Facility[], line_id: string, stop_id: string, user_url: string }) {
	...
	const renderedIcons = [];
	for (const facility of facilities.sort()) {
