export default function Header({ backgroundColor, color, dataurl, headsign, lineId }: { backgroundColor: string, color: string, dataurl: string, headsign: string, lineId: string }) {
	...
	return (
		<div className="p-[5mm] bg-black h-[30mm] text-white w-full flex items-center justify-between">
			<div className="flex flex-row justify-start gap-[4mm] items-center">
				<div
					className="text-center px-[10mm] py-2 font-bold rounded-full text-[40pt] leading-none flex items-center"
