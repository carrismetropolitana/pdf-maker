				...
				<div className='flex flex-row justify-between w-full'>
					<div className='flex flex-row justify-start gap-[10mm]'>
						...
						<div className='flex flex-row gap-[2.5mm] justify-start'>
							<div className='flex h-full w-[4mm] rounded-[5mm] flex-col justify-between' style={{ backgroundColor: pattern.color }}>
					...
					<div className='text-center px-[10mm] font-bold rounded-full text-[16mm]'
						style={{ backgroundColor: pattern.color, color: pattern.text_color }}>
						<p>3605</p>
					</div>
				</div>
			</div>
